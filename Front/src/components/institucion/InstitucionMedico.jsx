...
import { Box, Card, Grid, IconButton, Stack, Paper, TextField, Typography, ThemeProvider, Dialog } from '@mui/material'
...
export default function InstitucionMedico(tipo) {
                ...
                <Grid Item xs={4}>
                    <Card sx={{ height:'210px'}} variant='outlined'>
                        <Stack alignItems={'center'}>
                            <Typography variant='h5' sx={{my:1}}>Equipos Medicos</Typography>
                    ...
                    <Card sx={{ml:1,mr:2, height:'210px'}}  variant='outlined'>
                        <Stack sx={{m:1}}>
                            ...
                            <Stack direction='row' justifyContent={'space-between'} sx={{mt:1}}>
                                <Typography variant = 'subtitle2'>MC: {mc[0].mc ? mc[0].mc : 0}</Typography>
                                <Typography variant = 'subtitle2'>MC criticos: {mcc[0].mcc ? mcc[0].mcc : 0}</Typography>
                                <Typography variant = 'subtitle2' sx={{ mr: 8 }}>MC relevante: {mcr[0].mcc ? mcr[0].mcc : 0}</Typography>
                            </Stack>
