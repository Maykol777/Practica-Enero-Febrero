import { Box, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, MenuItem, Select, Typography } from '@material-ui/core'
...
export default function NuevaPlanificacionAnual({row, getequipos, getPreventiva, handleClose}) {
    const [open, setOpen] = useState(false);
    const handleOpen = () =>{setOpen(true)}
    const closeNueva = () =>{setOpen(false)}
  ...
  return (
    <>
        <IconButton
            ...
            color='primary'
        >
            <PlaylistAddCircleIcon sx={{fontSize:'50px'}}/>
        </IconButton>
        ...
        >
            ...
            <DialogContent>
                <Box sx={{flexGrow:1}} >
                    ...
                    <Stack direction='column' spacing={0.9} sx={{maxWidth:'190px'}} divider={<Divider orintation="horizontal" flexItem/>}>
            ...
            <DialogActions>
                ...
                <Box  >
                 <Button variant='contained' color='error' onClick={closeNueva}>Cancelar</Button>
                </Box>
                </Stack>
            </DialogActions>
        </Dialog>
