import { Box, Dialog, DialogActions, DialogContent, DialogTitle, FormControl, Grid, MenuItem, Select, Typography } from '@material-ui/core'
...
export default function NuevaPlanificacionAnualKm({row, getequipos, getPreventiva, handleClose}) {
