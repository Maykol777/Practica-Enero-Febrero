...
export default function OpenDialogIndustrial({row, getEquipos}){
  ...
  return (
    <>
        ...
        >
            {
                !cambioAct 
                ?<NuevaMP row={row} getEquipos={getEquipos} getPreventiva={getPreventiva} setOpen={setOpen} setCambioAct={setCambioAct}/>
